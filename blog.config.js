...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'dcab01ab4a324ebaaaf86a6e32d0c400',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Daachun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不想学美术的策划不是好程序', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Daachun.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Unity, 游戏开发, 技术美术, 人工智能, TA, Tech Artist, UE, Unreal Engine, Stable Diffusion, NovelAI, 游戏工业化, 3D', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'guoxc1996@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
